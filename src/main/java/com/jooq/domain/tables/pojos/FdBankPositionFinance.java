...
public class FdBankPositionFinance implements Serializable {

    private static final long serialVersionUID = -1171247477;
    ...
    public FdBankPositionFinance(FdBankPositionFinance value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("FdBankPositionFinance (");
