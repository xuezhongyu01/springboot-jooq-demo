...
public class FdFundLoans implements Serializable {

    private static final long serialVersionUID = -969308833;
    ...
    public FdFundLoans(FdFundLoans value) {
        this.id = value.id;
        ...
        this.penaltyRate = value.penaltyRate;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("FdFundLoans (");
        ...
        sb.append(", ").append(penaltyRate);
        sb.append(", ").append(refund);
