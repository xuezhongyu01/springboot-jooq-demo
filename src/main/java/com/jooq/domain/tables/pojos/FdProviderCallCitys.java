...
public class FdProviderCallCitys implements Serializable {

    private static final long serialVersionUID = -1711220514;
    ...
    public FdProviderCallCitys(FdProviderCallCitys value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("FdProviderCallCitys (");
